...
class Nivel1 extends JFrame implements MouseListener,KeyListener{
	...
	private int i,j,candle=0,bomb=0,posX=5,posY=0,vida=2,vidaAntigua,moviminetos=0,numPregunta,fogTurns;
	...
	public Nivel1(){
		...
		setDefaultCloseOperation(EXIT_ON_CLOSE);
		setTitle("Nivel 1");
		setSize(780,530);//para imagenes tiene tantos menos pixeles en el eje: X:-16px  Y:-39px pero si empiezan en (0.0)
		setLocationRelativeTo(null);
		setResizable(false);
		addKeyListener(this);
		setIconImage(new ImageIcon(getClass().getResource("images/KeyIcon.png")).getImage());
	...
	public void Tiles(){//pone las imagenes en los Labels adecuados
		...
		switch(numLav){//creacion del laberinto
			...
			case 3:
				...
				break;
			default:System.out.println("Error en integer numLav");
		}
		...
		for(j=0;j<4;j++){
			for(i=0;i<6;i++){
				switch(matEntities[j][i]){
					case 3: matLabelEnteties[j][i].setBounds(80*i+25,80*j+55,80,80);
						break;
					case 4: matLabelEnteties[j][i].setBounds(80*i+25,80*j+55,80,80);
						break;
					case 5: matLabelEnteties[j][i].setBounds(80*i+25,80*j+55,80,80);
						break;
					case 6: matLabelEnteties[j][i].setBounds(80*i+25,80*j+55,80,80);
						break;
				}
			}
		}
			...
			switch(e.getKeyCode()) {
				case 37: //izquierda
					switch(matParedes[posY][posX]){
						case 4: music.Play("music/Hit.wav");
								MovePlayerFace(3);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
						case 5: music.Play("music/Hit.wav");
								MovePlayerFace(3);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
						case 8: music.Play("music/Hit.wav");
								MovePlayerFace(3);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
						case 9: music.Play("music/Hit.wav");
								MovePlayerFace(3);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
						case 11: music.Play("music/Hit.wav");
								MovePlayerFace(3);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
						case 12: music.Play("music/Hit.wav");
								MovePlayerFace(3);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
						case 13: music.Play("music/Hit.wav");
								MovePlayerFace(3);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
				...
				case 38: //arriba
					switch(matParedes[posY][posX]){
						case 1: music.Play("music/Hit.wav");
								MovePlayerFace(1);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
						case 5: music.Play("music/Hit.wav");
								...
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
						case 6: music.Play("music/Hit.wav");
								MovePlayerFace(1);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
						case 10: music.Play("music/Hit.wav");
								MovePlayerFace(1);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
						...
						case 13: music.Play("music/Hit.wav");
								...
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
						case 14: music.Play("music/Hit.wav");
								MovePlayerFace(1);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
				...
				case 39: //derecha
					switch(matParedes[posY][posX]){
						case 2: music.Play("music/Hit.wav");
								MovePlayerFace(2);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
						case 6: music.Play("music/Hit.wav");
								...
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
						case 7: music.Play("music/Hit.wav");
								MovePlayerFace(2);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
				...
				case 40: //abajo
					switch(matParedes[posY][posX]){
						case 3: music.Play("music/Hit.wav");
								MovePlayerFace(1);
								moviminetos++;
								arrayLabel[10].setText("  Movimentos: "+moviminetos);
							break;
...
class Nivel2 extends JFrame implements MouseListener,KeyListener{
	public static int numLav;
	private int i,j,candle=0,bomb=0,posX=9,posY=0,vida=2,vidaAntigua,moviminetos=0,numPregunta,fogTurns;
	...
	public Nivel2(){
		...
		setDefaultCloseOperation(EXIT_ON_CLOSE);
		setTitle("Nivel 2");
		setSize(1100,660);//para imagenes tiene tantos menos pixeles en el eje: X:-16px  Y:-39px pero si empiezan en (0.0)
		setLocationRelativeTo(null);
		setResizable(false);
		addKeyListener(this);
		setIconImage(new ImageIcon(getClass().getResource("images/KeyIcon.png")).getImage());
	...
	public void Tiles(){//pone las imagenes en los Labels adecuados
		...
		switch(numLav){//creacion del laberinto
			case 1:
				int tipoTile[]={12,10,6,5,10,14,12,1,6,13,5,6,9,9,5,10,10,2,8,7,9,9,8,3,2,12,6,9,5,6,9,4,10,1,7,12,3,0,7,9,9,9,13,11,5,1,14,9,5,7,7,8,3,10,7,11,12,7,8,14};
				AjustarTipoTile(tipoTile);
				break;
			case 2:
				int tipoTile2[]={5,10,10,6,13,5,10,14,13,13,9,12,6,8,2,9,5,10,3,2,4,10,0,6,8,7,9,5,6,9,9,13,9,4,1,1,0,2,8,7,8,7,8,7,9,9,11,8,6,13,10,10,10,10,7,11,12,10,3,7};
				AjustarTipoTile(tipoTile2); 
				break;
			case 3:
				int tipoTile3[]={12,10,6,12,1,14,5,10,1,14,5,6,4,10,2,13,9,13,8,6,11,4,3,14,4,3,7,4,10,7,5,7,5,1,7,12,10,3,1,6,9,12,2,4,10,14,5,6,9,9,3,10,7,8,10,14,8,3,3,7};
				AjustarTipoTile(tipoTile3);
				break;
			default:System.out.println("Error en integer numLav");
		}
	...
	public void mouseClicked(MouseEvent e){
		...
		if(e.getSource() == matLabelPreguntas[numPregunta][1]){//boton respuesta a
			switch(numPregunta){//revisa si es correcta en cada pregunta
				...
				case 4: Correcto(false);
					break;
				case 5: Correcto(false);
					break;
				case 6: Correcto(false);
					break;
				case 7: Correcto(false);
					break;
				case 8: Correcto(false);
					break;
				case 9: Correcto(false);
					break;
				default:System.out.println("no jalo");
			}
			arrayLabel[34].setBounds(-595,200,100,20);//quita cuadro de pregunta
	...
	public void Preguntas(){
		...
		for(i=0;i<10;i++){//revisa que todas no se allan preguntado
			if(pregunta[i]==0) c++;
		}
		if(c==10){
			for(i=0;i<10;i++){
